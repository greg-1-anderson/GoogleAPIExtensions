...
west:
  ...
  public function testInsertOffice() {
    ...
    $testController->insertOffice()->shouldBeCalled()->withArguments(array(new AnyValueToken(), "_aggregated", "west-officers", array("group-name" => "West Officers", "group-email" => "west-officers@testdomain.org", "group-id" => "west-officers@testdomain.org", 'properties' => array('alternate-addresses' => array('officers@west.testdomain.org')))));
    $testController->configureOffice()->shouldBeCalled()->withArguments(array(new AnyValueToken(), "_aggregated", "west-officers", array("group-name" => "West Officers", "group-email" => "west-officers@testdomain.org", "group-id" => "west-officers@testdomain.org", 'properties' => array('alternate-addresses' => array('officers@west.testdomain.org')))));
    $testController->verifyOfficeConfiguration()->shouldBeCalled()->withArguments(array(new AnyValueToken(), "_aggregated", "west-officers", array("group-name" => "West Officers", "group-email" => "west-officers@testdomain.org", "group-id" => "west-officers@testdomain.org", 'properties' => array('alternate-addresses' => array('officers@west.testdomain.org')))));
    $testController->verifyOffice()->shouldBeCalled()->withArguments(array(new AnyValueToken(), "_aggregated", "west-officers", array("group-name" => "West Officers", "group-email" => "west-officers@testdomain.org", "group-id" => "west-officers@testdomain.org", 'properties' => array('alternate-addresses' => array('officers@west.testdomain.org')))));
